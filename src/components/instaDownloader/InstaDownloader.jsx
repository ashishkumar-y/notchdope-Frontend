...
//   // const backendApi = 'http://localhost:5001';
//      const backendApi = 'http://localhost:6900';
// //     // const backendApi = "https://notchdope-backend.up.railway.app";
...
// <FaInstagram className="text-white w-16 h-16 sm:w-20 sm:h-20 mx-auto" />
...
//                 alt="media"
//                 className="w-full object-cover rounded border border-green-600"
//               />
//             )}
//           </div>
...
//       }
//     } catch (error) {
//         console.error('🔥 FRONTEND ERROR:', error.response?.data || error.message); // ✅ Add this
  ...
  const getMedia = async (e) => {
    ...
    try {
      ...
      if (data.mediaUrl) {
        ...
        alert('Media not found. Try a different link.');
      }
    } catch (error) {
