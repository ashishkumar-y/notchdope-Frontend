...
//   const downloadAudio = () => {
//     setCurrentQuality('audio');
//     setShowHoldOn(true);

//     const encodedURL = encodeURIComponent(link);
//     // const downloadURL = `${BackendApi}/api/youtube/download-audio/${encodedURL}`;
//     const downloadURL = `${BackendApi}/api/youtube/download-audio/${encodedURL}`;
...
//               className="bg-gradient-to-r from-green-500 to-teal-500 px-6 py-3 rounded-lg text-white font-semibold shadow hover:scale-105 hover:brightness-110 transition-all"
//             >
//               🎵 Download Only Audio
//             </button>
//           </div>
...
//           </div>
//           <h2 className="text-xl font-semibold mt-5 text-white animate-pulse">
//             Wait on... Downloading {currentQuality}
//           </h2>
//         </div>
//       )}
...
const Download = () => {
  ...
  const downloadAudio = () => {
    setCurrentQuality('audio');
    setShowHoldOn(true);
    const downloadURL = `${BackendApi}/api/youtube/download-audio?url=${encodeURIComponent(link)}`;
